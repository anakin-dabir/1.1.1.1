...
class GUI:
    def __init__(self):
        ...
        self.app.setApplicationName('1.1.1.1')
    ...
    def init_tray_icon(self):
        ...
        self.__menu_tray_hide = QAction("Show")
    ...
    def tray_hide_show_clicked(self):
        if self.mainWindow.isHidden():
            ...
            self.__menu_tray_hide.setText("Hide")
        else:
            self.__menu_tray_hide.setText("Show")
    ...
    def status_thread(self):
        while not self.need_stop:
            ...
            if status.startswith('Connected'):
                ...
                self.ui.label_status_message.setStyleSheet(u"color:#c58590;")
                self.connected = False
